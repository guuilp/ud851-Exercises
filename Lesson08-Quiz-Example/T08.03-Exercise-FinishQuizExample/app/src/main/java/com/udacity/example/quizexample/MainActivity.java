...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextDefinition = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if(mData != null){
            ...
            mTextDefinition.setVisibility(View.INVISIBLE);

            Log.v("MainActivity.class", word + " - " + definition);
    ...
    public void showDefinition() {
        if (mData != null) {
            ...
            mTextDefinition.setVisibility(View.VISIBLE);
